...
export const MetadataField = z.object({
  ...
  const LineGraphVisualization = z.object({
    ...
    x_to_percentage: z.boolean().describe("True if the x-axis values should be converted to percentages"),
    y_to_percentage: z.boolean().describe("True if the y-axis values should be converted to percentages")
  });
  ...
  const BarChartVisualization = z.object({
    ...
    stacked: z.boolean().describe("True if the bar chart should be stacked")
  });
  ...
  const VisualizationTypes = z.discriminatedUnion("chart_type", [
